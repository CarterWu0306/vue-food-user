    ...
    <div class="menuBody" id="menuBody">
      <cube-scroll-nav
              ...
              <van-swipe :autoplay="3000" indicator-color="white">
                <van-swipe-item>
                  <van-image
                    width="100%"
                    height="150"
                    src="http://images.wukate.com/swiperImg.jpg"></van-image>
                </van-swipe-item>
                <van-swipe-item>
                  <van-image
                  width="100%"
                  height="150"
                  src="http://images.wukate.com/swiperImg.jpg">
                  </van-image>
                </van-swipe-item>
              </van-swipe>
            </ul>
            <cube-scroll-nav-panel
                    ...
                    :title="item.label">
                <ul>
                    <li v-for="(food,index) in goods">
                        <div v-show="food.goodsLabel === item.label">
                          <div class="food">
                            <van-overlay :show="show" v-show="food.goods_stock<=0" style="background-color: rgba(255,255,255,0.57)">
